...
import { WEB_TOKEN, USER_DETAILS, ERROR_MSG } from '../../constants/otherConstants';
...
class LandingPage extends Component {
  ...
  makePayment() {
    const data = {
      plan_id: this.state.choosenPlan.plan_id,
      total_count: 1,
      sub_type: 'PROPACK',
    };
    console.log(data);
    agent.Purchase.createSubscription(data).then((res) => {
      ...
      if(err.response.data)
        toast.errpr(err.response.data.error)
      else
    ...
    return (
      <div className="gradient-bg-landing-page">
        ...
        <div className="main-background">
          ...
          <div className="purchase-main-div tl">
            <h1 className='tl' >Order Summary</h1>
            <div className="purchase-div">
              <div className="purchase-content-div">
                <h1>{planName}</h1>
            ...
            <div className="purchase-button-div">
              {
                      loggedIn
                        ? (
                          ...
                          <button type="button" onClick={() => this.makePayment()}>
